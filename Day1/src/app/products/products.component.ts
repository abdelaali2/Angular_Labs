...
export class ProductsComponent implements OnInit {
  ...
  productList: IProduct[] = [
    { id: 1, name: 'Product 1', quantity: 10, price: 20, img: '../assets/product1.jpg' },
    { id: 2, name: 'Product 2', quantity: 5, price: 30, img: '../assets/product2.jpg' },
    { id: 3, name: 'Product 3', quantity: 2, price: 50, img: '../assets/product3.jpg' }
  ];
